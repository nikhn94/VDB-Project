...
*   mex '-IF:/IPG Carmaker/carmaker/win64-8.0.1/include' '-DLINUX' tire_lin.c
*   mex '-IF:/IPG Carmaker/carmaker/win64-8.0.1/include' '-DWIN32' tire_lin.c
* Compile in 64-bit Matlab with one of
*   mex '-IF:/IPG Carmaker/carmaker/win64-8.0.1/include' '-DLINUX' '-DLINUX64' tire_lin.c
*   mex '-IF:/IPG Carmaker/carmaker/win64-8.0.1/include' '-DWIN32' '-DWIN64'   tire_lin.c
*/
